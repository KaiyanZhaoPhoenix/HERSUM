...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--replay-buffer", type=str, default="per", choices=["normal", "per"])
    ...
    parser.add_argument("--wandb-project", type=str, default="PER-benchmark")
    parser.add_argument(
        "--watch",
        default=False,
        action="store_true",
...
def test_ddpg(args: argparse.Namespace = get_args()) -> None:
    ...
    buffer: VectorReplayBuffer | ReplayBuffer | PrioritizedReplayBuffer | PrioritizedVectorReplayBuffer
